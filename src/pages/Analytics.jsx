...
const Analytics = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-black dark:text-white mb-2">{t('analyticsAndTrends')}</h1>
      ...
      {/* Current Readings */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-black mb-4">{t('currentReadingsHeading')}</h2>
      ...
      {(yieldPrediction || harvestPrediction) && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-black mb-4">{t('yieldForecastHeading')}</h2>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-2xl font-bold text-black mb-4">{t('harvestProjectionHeading')}</h2>
            <div className="space-y-3">
      ...
      {area?.crop && (
        <div className="mt-8 bg-white rounded-lg shadow-md p-6">
          <h2 className="text-2xl font-bold text-black mb-4">{t('optimalParametersFor', { cropName: area.crop.name })}</h2>
